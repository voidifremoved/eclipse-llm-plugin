...
public class InMemoryClientServerFactory
{
     ...
     * {@link com.rubberjam.eclipse.assistai.mcp.annotations.McpServer}.
     * 
     * @param serverImplementation An object whose class is annotated with {@link com.rubberjam.eclipse.assistai.mcp.annotations.McpServer}
     *                            and contains methods annotated with {@link com.rubberjam.eclipse.assistai.mcp.annotations.Tool}
     * @return A record containing the synchronized client and server
     * @throws IllegalArgumentException If the serverImplementation is not annotated with {@link com.rubberjam.eclipse.assistai.mcp.annotations.McpServer}
     */
