...
public class McpServerFactory
{
    ...
    {
        var mcpServerAnnotation = serverImplementation.getClass().getAnnotation( com.rubberjam.eclipse.assistai.mcp.annotations.McpServer.class );
     ...
     * {@link com.rubberjam.eclipse.assistai.mcp.annotations.Tool}.
     * <p>
    ...
    private List<McpSchema.Tool> extractAnnotatedTools( Method ... methods )
    {
        ...
        {
            var toolAnnotation = method.getAnnotation( com.rubberjam.eclipse.assistai.mcp.annotations.Tool.class );
    ...
    {
        Optional.ofNullable( serverImplementation.getClass().getAnnotation( com.rubberjam.eclipse.assistai.mcp.annotations.McpServer.class ) )
