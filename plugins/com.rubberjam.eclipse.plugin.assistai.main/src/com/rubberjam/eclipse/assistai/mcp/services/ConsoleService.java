    ...
    public void clear(String consoleName)
    {
        ...
        sync.syncExec(() -> {
            try {
                ...
                logger.log(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.INFO, "com.rubberjam.eclipse.plugin.assistai.main", "Console '" + consoleName + "' cleared successfully."));
            } catch (Exception e) {
