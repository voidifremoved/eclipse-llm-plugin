...
public class PreferenceInitializer extends AbstractPreferenceInitializer
{
    ...
    public void initializeDefaultPreferences()
    {
        ...
        ModelApiDescriptor deepseek = new ModelApiDescriptor( "4e28814b-d7cd-42f5-bd3e-0df577a3d2c4", "deepseek", "https://api.deepseek.com/chat/completions", "", 10, 30, "deepseek-chat", 0.7f, false, true );
        ModelApiDescriptor gemini = new ModelApiDescriptor( "15742962-271f-4ffb-80aa-58224631015a", "gemini", "https://generativelanguage.googleapis.com/v1beta", "", 10, 30, "gemini-3-flash-preview", 0.7f, true, true );
