package com.rubberjam.eclipse.plugin.assistai.mcp.services;
    ...
    public void testRunJUnitPluginTestClass_realProject_passes()
    {
        try
        {
            String result = service.runJUnitPluginTestClass(
                "com.rubberjam.eclipse.plugin.assistai.main.tests",
                "com.rubberjam.eclipse.plugin.assistai.mcp.services.PDEServiceTest",
                120 );
