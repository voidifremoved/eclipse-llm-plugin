...
## Project Structure
- `plugins/com.rubberjam.eclipse.plugin.assistai.main/` — main plugin (Java 21, Eclipse PDE)
  - `src/com.rubberjam/eclipse/assistai/` — source root
...
- `tests/com.rubberjam.eclipse.plugin.assistai.main.tests/` — test project
